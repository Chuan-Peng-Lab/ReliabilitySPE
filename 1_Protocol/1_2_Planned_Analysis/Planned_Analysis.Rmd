...
# myfunction: splithalf
# install.packages("./splithalf_0.0.1.tar.gz")
library(splithalf)
```
...
df.clean <- df.raw %>% 
  ...
  dplyr::mutate_at(vars(Match, Identity, Session), as.factor) %>%
...
list.SHR.MC.para <- splithalf::sh_tool(df.split = df.clean, iteration = 10, nc = 16, method = "mc",
...
list.SHR.Per <- splithalf::sh_tool(df.split = df.clean, method = "permuted", 
                                   sub = "Subject", var1 = "Match", var2 = "Identity", var3 = "Session")
list.SHR.FS <- splithalf::sh_tool(df.split = df.clean, method = "fs", 
                                  sub = "Subject", var1 = "Match", var2 = "Identity", var3 = "Session")
list.SHR.OD <- splithalf::sh_tool(df.split = df.clean, method = "od", 
                                  sub = "Subject", var1 = "Match", var2 = "Identity", var3 = "Session")
