...
df.raw <-  read.csv('../reliability_ST_DE/simulated_data.csv',header = T, sep=",", stringsAsFactors = FALSE) 
df.clean <- df.raw %>% 
...
write.csv(df.DDM, "simulate_data_fitting_DDM.csv", row.names = FALSE)
```
...
df.DDM.raw <- read.csv("../reliability_ST_DE/test_retest_pilot_ddm_results.csv")
```
...
ggsave(filename="Figure1_SPE_ICC.png", width = 18, height = 10)
```
