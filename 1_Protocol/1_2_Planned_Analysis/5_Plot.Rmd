...
ggsave(filename="../1_2_Planned_Analysis/1_2_2_OUTPUT/Fig4_SPE_SHR.png", width = 15, height = 10)
```
...
ggsave(filename="../1_2_Planned_Analysis/1_2_2_OUTPUT/Fig5_SPE_ICC.png", width = 15, height = 20, dpi = 300)
```