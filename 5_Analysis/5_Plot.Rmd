...
p1 <- plot[[5]] %>%
  ...
  ggplot2::geom_vline(
    data = subset(plot[[5]], Target == "Close" & Indice == "RT"),
    aes(xintercept = r_8),
    linetype = "dotted", color = "black", linewidth = 1, alpha = 0.5
  ) +
  ggplot2::geom_vline(
    data = subset(plot[[5]], Target == "Stranger" & Indice == "RT"),
    aes(xintercept = r_8),
    linetype = "dotted", color = "black", linewidth = 1, alpha = 0.5
  ) +
  ggplot2::geom_vline(
    data = subset(
      plot[[5]], Target == "Close" & Indice == "ACC"),
      aes(xintercept = r_8),
    linetype = "dotted", color = "black", linewidth = 1, alpha = 0.5
  ) +
  ggplot2::geom_vline(
    data = subset(plot[[5]], Target == "Close" & Indice == "Efficiency"),
    aes(xintercept = r_8),
    linetype = "dotted", color = "black", linewidth = 1, alpha = 0.5
  ) +
  ggplot2::geom_vline(
    data = subset(plot[[5]], Target == "Stranger" & Indice == "Efficiency"),
    aes(xintercept = r_8),
    linetype = "dotted", color = "black", linewidth = 1, alpha = 0.5
  ) +
...
p2 <- plot[[5]] %>%
  ...
  ggplot2::geom_vline(
    data = subset(plot[[5]], Target == "Close" & Indice == "v(hausekeep)"),
    aes(xintercept = r_8),
    linetype = "dotted", color = "black", linewidth = 1, alpha = 0.5
  ) +
  ggplot2::geom_vline(
    data = subset(plot[[5]], Target == "Stranger" & Indice == "v(hausekeep)"),
    aes(xintercept = r_8),
    linetype = "dotted", color = "black", linewidth = 1, alpha = 0.5
  ) +
  ggplot2::geom_vline(
    data = subset(plot[[5]], Target == "Close" & Indice == "v(RWiener)"),
    aes(xintercept = r_8),
    linetype = "dotted", color = "black", linewidth = 1, alpha = 0.5
  ) +
  ggplot2::geom_hline(yintercept = 0.8, linetype = "dotted", color = "black", linewidth = 1, alpha = 0.5) + # nolint
...
ggsave(filename = "./FIGURE/Fig5_r&trial.png",
       width = 10,
       height = 8,
       )
rm(p1, p2, p3)
...
```{r}
plot[[6]] <- read.csv("./OUTPUT/icc/icc_cov_cmp.csv") %>%
  dplyr::mutate(
    Target = case_when(
      Target == "Friend" ~ "Close",
      Target == "Stranger" ~ "Stranger",
...
```{r}
ggplot2::ggplot(data = plot[[6]], aes(x = reorder(Target_Indice, Order), y = ICC2, fill = cov)) +
...
ggsave(filename = "./FIGURE/Fig3c_cov.png",
       width = 12,
       height = 8,
       )
```
...
ggsave(
  filename = "./FIGURE/Fig7_cor_yi&trials.png",
  width = 10,
  height = 8,
)
