...
lazy_nmshr <- function(Target, Paper_ID, nc) {
  ...
  # 计算8个参数的分半信度
  df_rt <- yukiBP::shr(list = shl[1:3], Target = Target, Paper_ID = Paper_ID, Indice = "rt", mc = FALSE, nc = nc) # nolint 
  df_acc <- yukiBP::shr(list = shl[1:3], Target = Target, Paper_ID = Paper_ID, Indice = "acc", mc = FALSE, nc = nc) # nolint 
  df_dp <- yukiBP::shr(list = shl[1:3], Target = Target, Paper_ID = Paper_ID, Indice = "dp", mc = FALSE, nc = nc) # nolint 
  df_eff <- yukiBP::shr(list = shl[1:3], Target = Target, Paper_ID = Paper_ID, Indice = "eff", mc = FALSE, nc = nc) # nolint 
  df_ezddm <- yukiBP::shr(list = shl[1:3], Target = Target, Paper_ID = Paper_ID, Indice = "ezddm", mc = FALSE, nc = nc) # nolint 
  df_rwddm <- yukiBP::shr(list = shl[1:3], Target = Target, Paper_ID = Paper_ID, Indice = "rwddm", mc = FALSE, nc = nc) # nolint 
...
for (i in 1:18) {
  ...
  # Permuted
  shl[[3]] <- yukiSH::sh_tool(df.split = df[[i]], method = "permuted", sub = "Subject", var1 = "Matching", var2 = "Identity", var3 = "Session") # nolint
  # Monte Carlo
  shl[[4]] <- yukiSH::sh_tool(df.split = df[[i]], method = "mc", sub = "Subject", var1 = "Matching", var2 = "Identity", var3 = "Session", iteration = 5000, nc = 10) # nolint 

  lazy_nmshr(Target = t[[i]], Paper_ID = p[[i]], nc = 10)
