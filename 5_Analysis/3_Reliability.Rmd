...
df.ddmv <- batch::shr(list = shl[1:3], indice = "ddmv", Target = "Friend", Paper_ID = "P95E2", mc = FALSE, nc = NULL)

df.ddmz <- batch::shr(list = shl[1:3], indice = "ddmz", Target = "Friend", Paper_ID = "P95E2", mc = FALSE, nc = NULL)
```
...
df.ddmv <- batch::shr(list = shl[1:3], indice = "ddmv", Target = "Stranger", Paper_ID = "Ps1E1", mc = FALSE, nc = NULL)

df.ddmz <- batch::shr(list = shl[1:3], indice = "ddmz", Target = "Stranger", Paper_ID = "Ps1E1", mc = FALSE, nc = NULL)
```
