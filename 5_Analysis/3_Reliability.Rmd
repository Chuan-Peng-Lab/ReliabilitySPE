...
df.ddmv <- batch::shr(list = shl[[4]], indice = "ddmv", Target = "Friend", Paper_ID = "P0E1", mc = TRUE)

df.ddmz <- batch::shr(list = shl[[4]], indice = "ddmz", Target = "Friend", Paper_ID = "P0E1", mc = TRUE)
```
