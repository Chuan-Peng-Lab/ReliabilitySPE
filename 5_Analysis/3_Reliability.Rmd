...
df_rwddm <<- yukiBP::shr(list = shl[[4]], indice = "rwddm", Target = "Friend", Paper_ID = "P0S1", mc = TRUE)
}
```
...
df_rwddm <- yukiBP::shr(list = shl[[4]], indice = "rwddm", Target = "Stranger", Paper_ID = "P0S1", mc = TRUE)
```
