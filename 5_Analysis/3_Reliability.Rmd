...
df_rt <<- yukiBP::shr(list = shl[[4]], indice = "rt", Target = Target, Paper_ID = Paper_ID, mc = TRUE)
df_acc <<- yukiBP::shr(list = shl[[4]], indice = "acc", Target = Target, Paper_ID = Paper_ID, mc = TRUE)
df_dp <<- yukiBP::shr(list = shl[[4]], indice = "dp", Target = Target, Paper_ID = Paper_ID, mc = TRUE)
df_eff <<- yukiBP::shr(list = shl[[4]], indice = "eff", Target = Target, Paper_ID = Paper_ID, mc = TRUE)
#df_ddmv <<- yukiBP::shr(list = shl[[4]], indice = "ddmv", Target = Target, Paper_ID = Paper_ID, mc = TRUE)
#df_ddmz <<- yukiBP::shr(list = shl[[4]], indice = "ddmz", Target = Target, Paper_ID = Paper_ID, mc = TRUE)
}
```
...
lazy_mcshr(Target = "Partner", Paper_ID = "P6S1")
```

```{r}
Start_Time <- Sys.time()
df_rwddm <- yukiBP::mt_mcshr_rwddm(list = shl[[4]], Target = "Partner", Paper_ID = "P6S1", nc = 16)
End <- Sys.time()
```
