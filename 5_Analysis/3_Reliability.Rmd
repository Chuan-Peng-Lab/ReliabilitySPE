...
## Self - Friend
```{r RT, message=FALSE, warning=FALSE}
df.rt <- batch::shr(list = shl[[4]], indice = "rt", Target = "Celebrity", Paper_ID = "P51E1", mc = TRUE)

df.acc <- batch::shr(list = shl[[4]], indice = "acc", Target = "Celebrity", Paper_ID = "P51E1", mc = TRUE)

df.dp <- batch::shr(list = shl[[4]], indice = "dp", Target = "Celebrity", Paper_ID = "P51E1", mc = TRUE)

df.eff <- batch::shr(list = shl[[4]], indice = "eff", Target = "Celebrity", Paper_ID = "P51E1", mc = TRUE)
```
...
```{r Save mcshr_friend}
write.csv(res[[2]][[1]], "./OUTPUT/mcshr_P51E1_celebrity.csv", row.names = FALSE)
```

## Self - Stranger
```{r RT, message=FALSE, warning=FALSE}
df.rt <- batch::shr(list = shl[[4]], indice = "rt", Target = "Stranger", Paper_ID = "P51E1", mc = TRUE)

df.acc <- batch::shr(list = shl[[4]], indice = "acc", Target = "Stranger", Paper_ID = "P51E1", mc = TRUE)

df.dp <- batch::shr(list = shl[[4]], indice = "dp", Target = "Stranger", Paper_ID = "P51E1", mc = TRUE)

df.eff <- batch::shr(list = shl[[4]], indice = "eff", Target = "Stranger", Paper_ID = "P51E1", mc = TRUE)
```
...
write.csv(res[[2]][[2]], "./OUTPUT/mcshr_P51E1_stranger.csv", row.names = FALSE)
```