...
Start_Time <- Sys.time()
df_rt <- yukiBP::shr(list = shl[1:3], Target = c("Self", "Friend", "Stranger"), Paper_ID = "P0S1", Indice = "rt", mc = FALSE, nc = 8) # nolint
df_acc <- yukiBP::shr(list = shl[1:3], Target = c("Self", "Friend", "Stranger"), Paper_ID = "P0S1", Indice = "acc", mc = FALSE, nc = 8) # nolint
df_dp <- yukiBP::shr(list = shl[1:3], Target = c("Self", "Friend", "Stranger"), Paper_ID = "P0S1", Indice = "dp", mc = FALSE, nc = 8) # nolint
df_eff <- yukiBP::shr(list = shl[1:3], Target = c("Self", "Friend", "Stranger"), Paper_ID = "P0S1", Indice = "eff", mc = FALSE, nc = 8) # nolint
df_ezddm <- yukiBP::shr(list = shl[1:3], Target = c("Self", "Friend", "Stranger"), Paper_ID = "P0S1", Indice = "ezddm", mc = FALSE, nc = 8) # nolint
df_rwddm <- yukiBP::shr(list = shl[1:3], Target = c("Self", "Friend", "Stranger"), Paper_ID = "P0S1", Indice = "rwddm", mc = FALSE, nc = 8) # nolint
End_Time <- Sys.time()
```
...
Start_Time <- Sys.time()
df_rt <- yukiBP::shr(list = shl[[4]], Target = c("Self", "Partner", "Stranger"), Paper_ID = "P6S1", Indice = "rt", mc = TRUE, nc = 16) # nolint
