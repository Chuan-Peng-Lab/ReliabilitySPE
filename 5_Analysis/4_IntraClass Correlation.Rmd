...
#df_ddmv <- yukiBP::icc(df = df[[1]], indice = "ddmv", Target = "Friend")
#df_ddmz <- yukiBP::icc(df = df[[1]], indice = "ddmz", Target = "Friend")
...
```{r DF for Plot ICC}
iccl[[1]] <- list(df_rt, df_acc, df_dp, df_eff, df_rwddmv, df_rwddmz)

rm(df_rt, df_acc, df_dp, df_eff, df_rwddmv, df_rwddmz)
```
