...
res_meta[[1]] <- list()
res_meta[[2]] <- list()
names(res_meta)[1] <- "Celebrity"
names(res_meta)[2] <- "NonPerson"
```
...
names(df_meta)[3] <- "Self - Celebrity"
```
...
names(df_meta)[4] <- "Self - NonPerson"
```
...
write.csv(
  x = res_meta[[3]],
  file = "./OUTPUT/meta/meta_celebrity_FEP.csv"
)
write.csv(
  x = res_meta[[4]],
  file = "./OUTPUT/meta/meta_nonperson_FEP.csv"
)
```
