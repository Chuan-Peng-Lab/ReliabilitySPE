...
```{r}
df_test <- df[[1]] %>%
  dplyr::filter(Subject == 6003 | Subject == 6004 |  Subject == 6006 | Subject == 6007 | Subject == 6010 | Subject == 6012 | Subject == 6014 | Subject == 6018 | Subject == 6021 | Subject == 6028 | Subject == 6005 | Subject == 6020 | Subject == 6009) 
write.csv(x = df_test, file = "./issuse.csv")
```
...
Start_Time <- Sys.time()
temp1 <- RWiener::wdm(df_test, xvar = "group", yvar = c("RT_sec", "ACC"))
End_Time <- Sys.time()
```
