...
for (i in 1:18) {
  ...
  # Permuted
  shl[[3]] <- yukiSH::sh_tool(df.split = df[[i]], method = "permuted", sub = "Subject", var1 = "Matching", var2 = "Identity", var3 = "Session", iteration = 5000, nc = 16) # nolint
  # Monte Carlo
  shl[[4]] <- yukiSH::sh_tool(df.split = df[[i]], method = "mc", sub = "Subject", var1 = "Matching", var2 = "Identity", var3 = "Session", iteration = 5000, nc = 16) # nolint 

  lazy_nmshr(Target = t[[i]], Paper_ID = p[[i]], nc = 10)
  lazy_pershr(Target = t[[i]], Paper_ID = p[[i]], nc = 10)
