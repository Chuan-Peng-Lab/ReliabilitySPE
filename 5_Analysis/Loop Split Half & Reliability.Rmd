...
for (i in 20) {
  ...
  # Permuted
  shl[[3]] <- yukiSH::sh_tool(df.split = df[[i]], method = "permuted", sub = "Subject", var1 = "Matching", var2 = "Identity", var3 = "Session", iteration = 10, nc = 16) # nolint
  # Monte Carlo
  ...
  lazy_pershr(Target = t[[i]], Paper_ID = p[[i]], nc = 16)
