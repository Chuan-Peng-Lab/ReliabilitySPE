---
title: "R simulate_pilot_data"
author: "Helen Liu & Yikang Liu"
date: "16/05/2022"
output: html_document
---

This script is used to generate the pilot data in stage 1 registration. We applied the Bootstrap methods where samples are drawn from the open data of Hu et al. (2020) (accessible at https://osf.io/mhdsn/, or in "2_2_1_refData" folder) with replacement (allowing the same sample to appear more than once in the pilot data). 
...
rsp_data = read_csv('../2_2_MaterialProc/2_2_1_refData/MS_rep_matchingTask_raw.csv') #reference of pilot data 
```
...
# check how many non-response trials we have 
sum(simdata$ACC == -1)
```
...
path_out = ("../2_3_PilotData/") # define path out 
