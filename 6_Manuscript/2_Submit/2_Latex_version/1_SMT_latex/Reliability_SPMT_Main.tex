...
\begin{sidewaystable}[!h]
	...
	\begin{tabular}{@{}lccp{4cm}@{}}
		...
		\textit{d}-prime ($d'$)    & $\mathcal{Z}\left(\text{Hits}\right)-\mathcal{Z}\left(\text{False Alarms}\right)$   & $\text{$d'$}_{\text{self-matching}}-\text{$d'$}_{\text{other-matching}}$  & \textcite{hu2020good,sui2012perceptual} \\
