...
\title[Reliability SPE ]{Supplementary Material for ``A Multiverse Assessment of the Reliability of the Self Matching Task as a Measurement of the Self-Prioritization Effect"}
...
\subsection{Methodological details of the dataset from \textcite{hu2023data}}\label{ExperimentalDesign}
